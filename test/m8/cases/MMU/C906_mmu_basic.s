...
# VPN:0x0  <-->  PPN:0x0
MMU_PTW_1G 0x0,0x80000,0xcf,0xf
# rv906 port delta (design 4.3 gap): the pinned 1G page above covers only
# VPN2=0 (VA [0,1G)), which maps the S-mode DATA at 0x30000 -> PA 0x80030000.
# But the S-mode CODE (TEST1, VA 0x800002b8, VPN2=2) and the tohost store
# (VA 0x7FFFF000, VPN2=1) live in OTHER 1G pages that the donor case never
# needed (donor image at 0x0 kept code+data+tohost all in VPN2=0). Map them:
MMU_PTW_1G 0x40000,0x40000,0xcf,0xf   # L1[1]: tohost VA 0x7FFFF000 -> PA 0x7FFFF000
MMU_PTW_1G 0x80000,0x80000,0xcf,0xf   # L1[2]: code  VA 0x800002b8 -> PA 0x800002b8
